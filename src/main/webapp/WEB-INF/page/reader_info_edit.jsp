...
<div class="col-xs-5 col-md-offset-3">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="reader_edit_r_do" method="post" id="edit" >
                <div class="input-group">
                    <span  class="input-group-addon">读者证号</span>
                    <input type="text" readonly="readonly" class="form-control" name="reader_id" id="reader_id" value="${OldReaderInfo.reader_id}">
                </div>
                <div class="input-group">
